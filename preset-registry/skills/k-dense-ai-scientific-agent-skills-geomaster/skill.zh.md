...
涵盖 GIS、遥感、空间分析和地球观测机器学习的综合地理空间科学技能，涉及 70 多个主题，并包含使用 8 种编程语言编写的 500 多个代码示例。
...
- **EPSG:326xx/327xx**（UTM）- 用于米制计算，每个分区的变形小于 1%
...
1. **始终检查 CRS**，然后再执行空间操作
2. 使用**投影 CRS**进行面积/距离计算
