...
纯 C/C++ 实现的 LLM 推理，依赖极少，针对 CPU 和非 NVIDIA 硬件优化。
...
| Apple M3 Max（Metal） | 50 tok/s | 基本相同 | $0（本地） |
...
- **[优化](references/optimization.md)** - 性能调优、CPU+GPU 混合
