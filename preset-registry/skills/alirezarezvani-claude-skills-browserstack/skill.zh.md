...
如果尚未设置，请告知用户如何从 [browserstack.com/accounts/settings](https://www.browserstack.com/accounts/settings) 获取它们，然后停止。
...
| `browserstack_update_session` | 标记为通过/失败 |
