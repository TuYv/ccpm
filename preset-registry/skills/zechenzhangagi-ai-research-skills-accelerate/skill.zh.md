...
**Megatron 集成**：张量并行、流水线并行和序列并行的设置请参阅 [references/megatron-integration.md](references/megatron-integration.md)。

**自定义插件**：创建自定义分布式插件及高级配置请参阅 [references/custom-plugins.md](references/custom-plugins.md)。

**性能调优**：性能分析、内存优化和最佳实践请参阅 [references/performance.md](references/performance.md)。
...
- 使用者：HuggingFace Transformers、TRL、PEFT，以及所有 HF 库
