...
**关键 — 开始前必须先用 Read 工具读取 [`../lark-shared/SKILL.md`](../lark-shared/SKILL.md)，其中包含认证、权限处理**
...
| 新建/创作复杂图表（架构/流程/组织等）                    | → **[§ 创作工作流](references/lark-whiteboard-workflow.md#创作-workflow)**                     |
| 修改/重绘已有画板                               | → **[§ 修改工作流](references/lark-whiteboard-workflow.md#修改-workflow)**                     |
