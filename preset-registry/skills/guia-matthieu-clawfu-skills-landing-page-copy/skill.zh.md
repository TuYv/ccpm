...
> 使用经过验证的结构、有说服力的版块和最佳实践，打造高转化率落地页。从首屏到页脚，每个元素都经过优化。
...
**来源**：综合 Unbounce 的研究、CXL Institute 的研究、Copyhackers 的方法论以及直接响应营销的最佳实践。

**核心原则**：落地页只有一个任务：促使访问者采取一项行动。每个元素——标题、正文、证明材料、CTA——都必须服务于这一个转化目标。

**为何重要**：落地页的平均转化率为 5%–15%，表现最好的落地页可达到 25% 以上。差异几乎总是在文案和结构上，而非设计上。
...
1. **构建完整的落地页结构** - 逐个版块规划
2. **撰写各个页面元素** - 标题、正文、要点和 CTA
3. **根据目标匹配结构** - 潜在客户开发、销售、产品、活动
4. **审查现有页面** - 识别转化障碍
5. **创建页面模板** - 可复用的框架
...
[描述：用 2-3 句话说明它是什么，以及它如何解决这些问题]

[唯一关键差异化优势：让你脱颖而出的那一点]
...
- Wiebe, Joanna. Copyhackers 落地页框架
- Schwartz, Eugene. 应用于落地页的认知阶段
- Google. 网页体验和 Core Web Vitals 研究

## 相关技能

- [copy-frameworks](../copy-frameworks/) - 用于页面结构的 PAS、AIDA
- [headline-formulas](../headline-formulas/) - 首屏区的标题
- [cta-writing](../cta-writing/) - 贯穿整个页面的 CTA
- [persuasion-cialdini](../persuasion-cialdini/) - 心理触发因素
