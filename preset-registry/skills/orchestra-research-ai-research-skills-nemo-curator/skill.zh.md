...
- 从网页抓取数据（Common Crawl）准备 LLM 训练数据
- 需要快速去重（比 CPU 快 16 倍）
...
- **Ray Data**：通用 ML 数据处理工具（不专注于数据整理）
...
- **[过滤指南](references/filtering.md)** - 30 多种质量过滤器和启发式方法
- **[去重指南](references/deduplication.md)** - 精确、模糊和语义方法
