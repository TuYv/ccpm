...
Comprehensive performance optimization guide for React and Next.js applications, maintained by Vercel. Contains 77 rules (70 upstream + 7 local) across 8 categories, prioritized by impact to guide automated refactoring and code generation.
