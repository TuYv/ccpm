...
用于与 NEAR 区块链交互的 JavaScript/TypeScript 库。可在浏览器和 Node.js 中运行。
...
| 主网（FastNEAR）   | `https://free.rpc.fastnear.com` |
| 测试网             | `https://rpc.testnet.near.org`  |
| 测试网（FastNEAR） | `https://test.rpc.fastnear.com` |
...
- [API 模式参考](references/api_patterns.md) - 完整的 Account/Provider 方法参考、手动签名、并行交易
- [代币指南](references/tokens_guide.md) - FT/NFT 操作、存储存款、预定义代币
- [密钥管理](references/key_management.md) - KeyPair 类型、助记词、签名器、访问密钥
- [元交易](references/meta_transactions.md) - 无 Gas 交易、中继器集成
- [NEP-413](references/nep413.md) - NEP-413 消息签名与验证
- [合约](references/contracts.md) - 带 ABI 的类型化 Contract、无 ABI 的 Contract