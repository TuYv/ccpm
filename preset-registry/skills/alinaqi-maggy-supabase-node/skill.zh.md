...
使用 Supabase Auth 和 Drizzle ORM 的 Express/Hono 模式。

**来源：** [Supabase JS Client](https://supabase.com/docs/reference/javascript/introduction) | [Drizzle ORM](https://orm.drizzle.team/)

---

## 核心原则

**使用 Drizzle 进行查询，使用 Supabase 处理身份验证/存储，使用中间件进行验证。**

使用 Drizzle ORM 进行类型安全的数据库访问。使用 Supabase 客户端进行身份验证、存储和实时功能。使用 Express 或 Hono 作为 API 层。
