...
- **基于角色**：智能体具有角色、目标和背景故事
- **双重范式**：Crews（自主式）+ Flows（事件驱动式）
- **50+ 种工具**：网页抓取、搜索、数据库、AI 服务
- **记忆**：短期记忆、长期记忆和实体记忆
- **生产就绪**：追踪、企业级功能

**以下情况改用其他方案：**
- **LangChain**：通用 LLM 应用、RAG 流水线
- **LangGraph**：具有循环的复杂有状态工作流
- **AutoGen**：Microsoft 生态系统、多智能体对话
...
任务按顺序执行，每个智能体完成自己的任务后，下一个智能体再开始：
