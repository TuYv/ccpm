...
面向 LLM 和 VLM 的高性能服务框架，采用 RadixAttention 实现自动前缀缓存。
...
**性能**：
- 对具有共享系统提示词的智能体工作负载，速度提升 **5 倍**
- 对包含重复示例的少样本提示，速度提升 **10 倍**
- **零配置**——自动运行
...
**Apple**：M1/M2/M3，通过 MPS 支持（实验性）

## 参考资料

- **[结构化生成指南](references/structured-generation.md)** - JSON 模式、正则表达式、语法、验证
