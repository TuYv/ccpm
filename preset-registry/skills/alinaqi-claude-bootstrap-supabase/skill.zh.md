...
适用于所有 Supabase 项目的核心概念、CLI 工作流和通用模式。
...
使用 Supabase CLI 在本地进行开发，将所有变更记录为迁移，并通过 CI/CD 部署。
...
### 方案 3：ORM 迁移（最佳开发者体验）
使用 Drizzle（TypeScript）或 SQLAlchemy（Python）——请参阅特定于框架的技能文档。
