...
**版本说明：**示例以 **benchling-sdk 1.25.0**（PyPI 上最新的稳定版本）为目标版本。文档：[benchling.com/sdk-docs](https://benchling.com/sdk-docs/)。平台指南：[docs.benchling.com](https://docs.benchling.com/)。
...
- 将网络调用 exclusively 路由到你的租户 URL
- 如果密钥遭到泄露，请进行轮换；对于多用户生产应用，请使用 OAuth
