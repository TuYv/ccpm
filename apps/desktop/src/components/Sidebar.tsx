...
const ICONS = {
  ...
  skills: (
    <NavIcon
      d={<path d="M8 1.5l1.7 3.6 4 .5-2.9 2.7.8 4-3.6-2-3.6 2 .8-4L2.3 5.6l4-.5L8 1.5Z" />}
    />
  ),
  mcps: (
    <NavIcon
  ...
  installed: (
    <NavIcon
      d={<path d="M2.5 9.5l5.5 4 5.5-4M2.5 6.5L8 10.5l5.5-4L8 2.5 2.5 6.5Z" />}
    />
  ),
  backups: (
    <NavIcon
...
const LIBRARY = [
  { to: "/recipes", label: "配方", icon: ICONS.recipes, countKey: "recipes" as const },
  { to: "/presets", label: "Presets", icon: ICONS.presets, countKey: "presets" as const },
  { to: "/skills", label: "Skills", icon: ICONS.skills, countKey: "skills" as const },
  { to: "/mcp", label: "MCP", icon: ICONS.mcps, countKey: "mcps" as const },
];

const STATE_NAV = [
  { to: "/installed", label: "已安装", icon: ICONS.installed, countKey: "installed" as const },
  { to: "/backups", label: "备份", icon: ICONS.backups, countKey: "backups" as const },
  { to: "/claude-settings", label: "Claude 配置", icon: ICONS.config, countKey: undefined },
];
